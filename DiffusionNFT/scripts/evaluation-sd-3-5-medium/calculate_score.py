...
if __name__ == "__main__":
    ...
    # )
    parser.add_argument(
        "--dataset", type=str, required=True, choices=["geneval", "ocr", "pickscore", "drawbench", "pick_a_pic_spo", "drawbench-analysis", "x_aigd", "pick_a_pic_v2", "pickscore_validation"], help="Dataset type."
    )
    parser.add_argument(
        "--output_dir",
        type=str,
