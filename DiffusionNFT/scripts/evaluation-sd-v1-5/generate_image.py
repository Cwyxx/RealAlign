...
def main(args):
    ...
    elif args.dataset in ["HPDv2-anime", "HPDv2-anime-all", "HPDv2-concept-art", "HPDv2-paintings", "HPDv2-photo"]:
        dataset = TextPromptDataset(dataset_path, split="test")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--dataset", type=str, required=True, choices=["partiprompts", "geneval", "ocr", "pickscore", "drawbench", "pick_a_pic_spo", "pickscore_train", "x_aigd", "pick_a_pic_v2", "pickscore_validation", "drawbench-unique", "HPDv2-anime", "HPDv2-anime-all", "HPDv2-concept-art", "HPDv2-paintings", "HPDv2-photo"], help="Dataset type."
    )
    parser.add_argument(
        "--output_dir",
        type=str,
