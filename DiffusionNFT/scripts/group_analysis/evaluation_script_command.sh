...
base_image_dir="/data_center/data2/dataset/chenwy/21164-data/diffusionnft/generate_images_num_steps_${num_step}/sd3_textencoder_3_none_cfg_${cfg_guidance}/${dataset}"
