...
method="fuse_lora/${combination_type}/pickscore_1.0-code-beta_0.1-cfg_4.5_1.0"
cfg_guidance=1.0
ckpt=1
...
ckpt_dirs=(
        ...
        "/data_center/data2/dataset/chenwy/21164-data/diffusionnft/model-ckpt/sd3/code-beta_0.1-cfg_4.5/checkpoints/checkpoint-1"
        )
lora_weights=(1.0 1.0)
adapter_names=("pickscore" "code-beta_01-cfg_45")
echo "********************************************"
