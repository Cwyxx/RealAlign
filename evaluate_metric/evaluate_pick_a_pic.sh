...
generated_image_dir="/data_center/data2/dataset/chenwy/21164-data/generated_image-seed_${seed}-num_inference_steps_${num_inference_steps}-dpmsolver/${finetune_method}/checkpoint_${checkpoint}_${global_step}" # "/data_center/data2/dataset/chenwy/21164-data/generated_image-seed_1/stable_diffusion_v1_4/spo_4k/${finetune_method}/checkpoint_${checkpoint}_${global_step}"
...
rm /data3/chenweiyan/notebook/fine-tune-diffusion/spo_gitee/evaluate_metric/evaluate_result.txt
...
HF_ENDPOINT=https://hf-mirror.com CUDA_VISIBLE_DEVICES=3 python3 -m vila.run_vila_predict_by_gemini \
