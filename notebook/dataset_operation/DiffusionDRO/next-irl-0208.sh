...
top_N=512
learning_rate=1e-4
echo "Inpo_official-IRL_top_${top_N}_images_no_anime_colorfulness_pickscore_0.02-hpdv3_all -- Inverse Reinforcement Learning"
unet_init="JaydenLu666/InPO-SD1.5" # "runwayml/stable-diffusion-v1-5" 
run_name="inpo_official-irl_top_${top_N}_images_no_anime_colorfulness_pickscore_0.02-hpdv3_all-uids_lr_${learning_rate}"
