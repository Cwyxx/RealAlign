...
top_N=512
learning_rate=1e-4
echo "IRL_top_${top_N}_images_no_anime_colorfulness_pickscore_0.03-hpdv3_all -- Inverse Reinforcement Learning"
unet_init="runwayml/stable-diffusion-v1-5" 
run_name="irl_top_${top_N}_images_no_anime_colorfulness_pickscore_0.03-hpdv3_all-uids_lr_${learning_rate}"
output_dir="/data_center/data2/dataset/chenwy/21164-data/diffusion-dro/sd-v1-5/model-ckpt/${run_name}"
train_dataset="/data_center/data2/dataset/chenwy/21164-data/dpo_dataset/pick-a-pic-v2/DiffusionDRO-HPDv3-top_${top_N}_images_no_anime_colorfulness_pickscore_0.03-hpdv3_all"
