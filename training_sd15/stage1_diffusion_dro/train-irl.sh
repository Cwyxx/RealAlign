...
learning_rate=1e-4
num_steps=3200
echo "IRL-top_1024_images_no_anime_colorfulness_pickscore_0.02-hpdv3_all -- Inverse Reinforcement Learning"
unet_init="runwayml/stable-diffusion-v1-5" 
run_name="irl_top_1024_images_no_anime_colorfulness_pickscore_0.02-hpdv3_all-ckpt_3200"
output_dir="/data_center/data2/dataset/chenwy/21164-data/diffusion-dro/sd-v1-5/model-ckpt/${run_name}"
train_dataset="/data_center/data2/dataset/chenwy/21164-data/dpo_dataset/pick-a-pic-v2/DiffusionDRO-HPDv3-top_1024_images_no_anime_colorfulness_pickscore_0.02-hpdv3_all"
