...
lora_name_or_path_content="/data_center/data2/dataset/chenwy/21164-data/stable_diffusion/stable_diffusion_v1_5/spo_4k/spo-sdv1-5/step_aware/checkpoint_1_754"
lora_name_or_path_style="/data_center/data2/dataset/chenwy/21164-data/stable_diffusion/stable_diffusion_v1_5/spo_4k/spo-sdv1-5/code-lr_6e-05-max_gn_1.0-comp_0.0-divert_start_step_15/checkpoint_0_750"

seed=42
num_inference_steps=50
checkpoint=0
global_step=0
finetune_method="spo-sdv1-5/fuse_lora/k_lora/step_aware_1.0-code-divert_start_step_15_1.0" # DRaFT_LV-adv-5-imagereward-JPEG_1.0_80_100-grad_scale_0.1 DRaFT_LV-hpsv2
...
HF_ENDPOINT=https://hf-mirror.com CUDA_VISIBLE_DEVICES=4 python sd_generate_image.py --pretrained_model_name_or_path "runwayml/stable-diffusion-v1-5" \
    ...
    --lora_name_or_path_content ${lora_name_or_path_content} \
    --lora_name_or_path_style ${lora_name_or_path_style}