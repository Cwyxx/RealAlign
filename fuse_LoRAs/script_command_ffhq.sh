...
checkpoint=0
global_step=0
finetune_method="spo-sdv1-5/fuse_lora/step_aware_0.5-dinov2_0.5" # DRaFT_LV-adv-5-imagereward-JPEG_1.0_80_100-grad_scale_0.1 DRaFT_LV-hpsv2
generated_image_output_dir="/data_center/data2/dataset/chenwy/21164-data/generated_image-seed_${seed}/stable_diffusion_v1_5/${train_caption_dataset}/ffhq_10k/${finetune_method}/checkpoint_${checkpoint}_${global_step}"



# runwayml/stable-diffusion-v1-5 CompVis/stable-diffusion-v1-4
HF_ENDPOINT=https://hf-mirror.com CUDA_VISIBLE_DEVICES=5 python main.py --pretrained_model_name_or_path "runwayml/stable-diffusion-v1-5" \
