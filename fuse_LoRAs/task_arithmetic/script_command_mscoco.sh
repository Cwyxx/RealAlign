...
checkpoint=0
global_step=0
finetune_method="spo-sdv1-5/fuse_lora/${combination_type}/step_aware_1.0-code-divert_start_step_15_1.0" # DRaFT_LV-adv-5-imagereward-JPEG_1.0_80_100-grad_scale_0.1 DRaFT_LV-hpsv2
