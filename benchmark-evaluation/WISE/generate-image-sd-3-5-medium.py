...
class WISEPromptDataset(Dataset):
    ...
    def __init__(self, data_dir: str, dataset: str = "wise"):
        ...
        assert (
            len(self.prompts) == 1000
        ), f"WISE expects 1000 prompts, got {len(self.prompts)}"
...
def main(args):
    ...
    print("Running WISE evaluation with SD-3.5-M on 1 GPU.")
    if enable_amp:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Generate SD-3.5-M images on the WISE benchmark prompts."
    )
    parser.add_argument(
        "--seed",
        type=int,
    ...
    parser.add_argument(
        "--output_dir",
        type=str,
        default="/data_center/data2/dataset/chenwy/21164-data/diffusionnft/generate_images/sd3_wise",
