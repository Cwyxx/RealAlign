...
# SD-v1.5 RealBench Long Prompt Generation Script
...
# Paths configuration
prompt_file="/long-img/banchmark/long_prompts.txt"
...
base_image_dir="/data_center/data2/dataset/chenwy/21164-data/${rl_framework}/sd-v1-5/generate_images/realgen-long"
...
echo "SD-v1.5 long prompt generation completed!"
