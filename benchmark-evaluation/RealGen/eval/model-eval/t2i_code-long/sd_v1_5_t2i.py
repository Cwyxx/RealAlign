...
def main(args):
    ...
    if args.unet_init != "runwayml/stable-diffusion-v1-5":
        ...
        pipeline = StableDiffusionPipeline.from_pretrained("runwayml/stable-diffusion-v1-5", unet=unet, torch_dtype=torch.float16)
    else:
        pipeline = StableDiffusionPipeline.from_pretrained(args.unet_init, torch_dtype=torch.float16)
