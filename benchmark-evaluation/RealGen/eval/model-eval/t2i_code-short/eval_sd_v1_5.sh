...
# Forensic-Chat and OmniAID Evaluation for SD-v1.5
# Usage: bash forensic_chat_eval_sd_v1_5.sh [cuda_device] [method] [checkpoint] [rl_framework]
...
base_image_dir="/data_center/data2/dataset/chenwy/21164-data/${rl_framework}/sd-v1-5/generate_images/realgen/${method}/ckpt-${ckpt}"
...
echo ""
echo "All evaluations completed for SD-v1.5!"
