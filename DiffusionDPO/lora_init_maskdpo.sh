...
run_name="irl_top_${top_N}_images_no_anime_colorfulness_pickscore_0.02-hpdv3_all_ckpt_1600-maskdpo_top_${top_N}_images_no_anime_colorfulness_pickscore_0.02-hpdv3_all_inpainting"
...
accelerate launch --mixed_precision="fp16"  train-lora_init_maskdpo.py --pretrained_model_name_or_path ${unet_init} \
    --train_batch_size 2 \
