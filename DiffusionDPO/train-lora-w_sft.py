...
def main():
    ...
    config.dpo.dataset = {
        "train" : "hpsv3-3-general-inpainting",
        "val": "high_quality_val"
    }
    config.dpo.csv_file_path = {
        "hpsv3-3-general-inpainting": "/data_center/data2/dataset/chenwy/21164-data/dpo_dataset/u2net_next_inpainting/general_1/hpsv3_3_uids.csv",
