...
def main():
    ...
    config.dpo.dataset = {
        "train" : "top_256_images_no_anime_colorfulness_pickscore_002-hpdv3_all-inpainting",
        "val": "high_quality_val"
    }
    config.dpo.csv_file_path = {
        "top_256_images_no_anime_colorfulness_pickscore_002-hpdv3_all-inpainting": "/data_center/data2/dataset/chenwy/21164-data/dpo_dataset/u2net_next_inpainting/HPDv3/top_256_images_no_anime_colorfulness_pickscore_0.02-hpdv3_all-uids.csv",
