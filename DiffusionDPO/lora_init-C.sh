...
run_name="irl_top_${top_N}_images-no_anime-hpdv3_all-uids-ckpt_1600-dpo_${beta_dpo}"
pretrained_lora_path="/data_center/data2/dataset/chenwy/21164-data/diffusion-dro/sd-v1-5/model-ckpt/irl_top_${top_N}_images-no_anime-hpdv3_all-uids/checkpoints/checkpoint-${ckpt}"
output_dir="/data_center/data2/dataset/chenwy/21164-data/diffusion-dpo/sd-v1-5/model-ckpt/${run_name}"
csv_file_path_train="/data_center/data2/dataset/chenwy/21164-data/dpo_dataset/u2net_next_inpainting/HPDv3/top_${top_N}_images-no_anime-hpdv3_all-uids.csv"
