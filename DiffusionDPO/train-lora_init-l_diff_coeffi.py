...
def parse_args():
    ...
    # )
    parser.add_argument(
        "--csv_file_path_train", type=str, default=None, help="CSV file path for train dataset"
    )
...
class Paired_Real_Fake_Dataset(Dataset):
    def __init__(self, config, tokenize_caption, image_transform, split):
        ...
        if "high_quality_val" in split: self.df = self.df.head(8)
...
def main():
    ...
    config.dpo.csv_file_path = {
        "train": args.csv_file_path_train,
    ...
    #         "high_quality_val": "/data_center/data2/dataset/chenwy/21164-data/dpo_dataset/paired_real_generated_dataset/high_quality_val/high_quality_val.csv"
    #     }
    # if args.dataset_type == "hpdv3_all-saliency_inpainting-full_inpainting-str_0.8-cfg_3.0":
    #     config.dpo.dataset = {
    #         "train" : f"saliency_inpainting-full_inpainting-str_08-cfg_30_top_{args.top_N}_images_NAC_pickscore_002-hpdv3_all-uids",
    #         "val": "high_quality_val"
    #     }
    #     config.dpo.csv_file_path = {
    #         f"saliency_inpainting-full_inpainting-str_08-cfg_30_top_{args.top_N}_images_NAC_pickscore_002-hpdv3_all-uids": f"/data_center/data2/dataset/chenwy/21164-data/dpo_dataset/saliency_inpainting-full_inpainting/saliency_inpainting-full_inpainting-str_0.8-cfg_3.0_top_{args.top_N}_images_NAC_pickscore_0.02-hpdv3_all-uids.csv",
    #         "high_quality_val": "/data_center/data2/dataset/chenwy/21164-data/dpo_dataset/paired_real_generated_dataset/high_quality_val/high_quality_val.csv"
    #     }
    
    # elif args.dataset_type == "hpdv3_all-full_inpainting-strength_0.8-guidance_scale_3.0":
    #     config.dpo.dataset = {
    #         "train" : f"full_inpainting-strength_08-guidance_scale_30_top_{args.top_N}_images_no_anime_colorfulness_pickscore_002-hpdv3_all-uids",
    #         "val": "high_quality_val"
    #     }
    #     config.dpo.csv_file_path = {
    #         f"full_inpainting-strength_08-guidance_scale_30_top_{args.top_N}_images_no_anime_colorfulness_pickscore_002-hpdv3_all-uids": f"/data_center/data2/dataset/chenwy/21164-data/dpo_dataset/full_inpainting-strength_0.8-guidance_scale_3.0/HPDv3/top_{args.top_N}_images_no_anime_colorfulness_pickscore_0.02-hpdv3_all-uids.csv",
    #         "high_quality_val": "/data_center/data2/dataset/chenwy/21164-data/dpo_dataset/paired_real_generated_dataset/high_quality_val/high_quality_val.csv"
    #     }
        
    # elif args.dataset_type == "hpdv3_all-saliencyInpainting-pixart":
    #     config.dpo.dataset = {
    #         "train" : f"saliencyInpainting-pixart_top_{args.top_N}_images_NAC_pickscore_002-hpdv3_all-uids",
    #         "val": "high_quality_val"
    #     }
    #     config.dpo.csv_file_path = {
    #         f"saliencyInpainting-pixart_top_{args.top_N}_images_NAC_pickscore_002-hpdv3_all-uids": f"/data_center/data2/dataset/chenwy/21164-data/dpo_dataset/u2net-next-pixart-inpainting/HPDv3/top_{args.top_N}_images_no_anime_colorfulness_pickscore_0.02-hpdv3_all-uids.csv",
    #         "high_quality_val": "/data_center/data2/dataset/chenwy/21164-data/dpo_dataset/paired_real_generated_dataset/high_quality_val/high_quality_val.csv"
    #     }
    
    # elif args.dataset_type == "hpdv3_all-saliencyInpainting-sd3.5m":
    #     config.dpo.dataset = {
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            if accelerator.sync_gradients:
                ...
                if accelerator.is_main_process:
                    ...
                    swanlab.log({"train_loss": train_loss, "train_dpo_loss": train_dpo_loss, "train_w_diff": train_w_diff, "train_l_diff": train_l_diff}, step=global_step)  
                if args.train_method == 'dpo':
            ...
            logs = {"step_loss": loss.detach().item(), "step_dpo_loss": loss_dpo.detach().item(), "step_w_diff": w_diff.detach().item(), "step_l_diff": l_diff.detach().item(), "lr": lr_scheduler.get_last_lr()[0]}
            if args.train_method == 'dpo':
