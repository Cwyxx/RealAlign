...
def main(args):
    ...
    if args.checkpoint_path is not None and os.path.exists(args.checkpoint_path):
        ...
        pipeline.load_lora_weights(
            args.checkpoint_path, weight_name="pytorch_lora_weights.safetensors"
        )
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Generate SD-v1.5 images for DPG-Bench prompts."
    )
    parser.add_argument(
        "--prompts_dir",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default=None,
        help="Local path to LoRA checkpoint directory containing pytorch_lora_weights.safetensors.",
    )
    parser.add_argument(
        "--output_dir",
        type=str,
